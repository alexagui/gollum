...
$(document).ready(function() {
  ...
  $('#head a.should-login').click( function(e) {
    $('#wiki-content, #wiki-history').prepend($('<div class="row" id="flash_messages"><div class="span12"><div class="alert" style="">You must be a <a href="/sign_in">logged-in</a> <em>editor</em> to do that. Please <a href="/contact">contact us</a> and request editor permission if you want to contribute to the wiki.<div class="close"></div><div class="clear"></div></div></div></div>').fadeIn('slow'));
    e.preventDefault();
  } );
